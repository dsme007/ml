# -*- coding: utf-8 -*-
"""
Created on Tue Jun  9 11:50:54 2020
...
# feature scaling
# only use this because of the contourplot below.
# if you want the true plot of the DT, ignore feature scalling
from sklearn.preprocessing import StandardScaler
sc = StandardScaler()
X_train = sc.fit_transform(X_train)
X_test = sc.transform(X_test)

# fit to random forest classifer model
